...
var ResearchPath = ["R-Struc-Research-Upgrade09", "R-Wpn-MG5", "R-Wpn-MG-Damage08", "R-Vehicle-Prop-Tracks",
					...
					"R-Defense-RotMG"];
var ResearchStages = new Array	( // Expanded research path triggered when a piece of tech becomes available.
...
var TruckTemplates = new Array( // Truck templates. We just iterate through these.
				[body_Bug,	prop_Tracks,	 "Spade1Mk1"],
				[body_Viper,	prop_Halftracks, "Spade1Mk1"],
				[body_Viper,	prop_Wheels,	 "Spade1Mk1"]);
var AT_TankTemplates = new Array(); // Tank pre-templates.
var AP_TankTemplates = new Array(
				...
				[body_Leopard,	prop_Tracks,		"Laser2PULSEMk1"],
				[body_Leopard,	prop_Tracks,		"MG5TWINROTARY"],
				[body_Leopard,	prop_Tracks,		"MG4ROTARYMk1"],
				[body_Leopard,	prop_Tracks,		"MG3Mk1"],
				[body_Leopard,	prop_Halftracks,	"MG3Mk1"],
